  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8F9FF] to-[#FFFFFF] p-6">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-[#6366F1] text-white font-medium text-sm mb-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="p-6 rounded-xl bg-white shadow-sm border border-gray-100">
              ...
              <button className="w-full mt-4 flex items-center justify-center gap-2 bg-[#6366F1] text-white rounded-lg py-3 px-4 hover:bg-[#5558E3] transition-colors">
            ...
            <div className="p-6 rounded-xl bg-white shadow-sm border border-gray-100">
              ...
              <button className="w-full mt-4 flex items-center justify-center gap-2 bg-[#EC4899] text-white rounded-lg py-3 px-4 hover:bg-[#D03A87] transition-colors">
